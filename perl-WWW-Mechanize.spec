...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/WWW-Mechanize-2.01.tar.gz
...
%prep
%setup -q -n WWW-Mechanize-2.01
cd %{_builddir}/WWW-Mechanize-2.01
...
cp %{_builddir}/WWW-Mechanize-2.01/LICENSE %{buildroot}/usr/share/package-licenses/perl-WWW-Mechanize/10492898635756fefba5e986b76a196b25b136ea
if test -f Makefile.PL; then
