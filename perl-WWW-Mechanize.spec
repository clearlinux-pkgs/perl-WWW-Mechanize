...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/WWW-Mechanize-2.05.tar.gz
...
%prep
%setup -q -n WWW-Mechanize-2.05
cd %{_builddir}/WWW-Mechanize-2.05
...
cp %{_builddir}/WWW-Mechanize-2.05/LICENSE %{buildroot}/usr/share/package-licenses/perl-WWW-Mechanize/bebe8ab2b9bcb82f3e41d3274a35b37ba3ee7b24
if test -f Makefile.PL; then
